    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $(".data-table").DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: '<?php echo route('forms.data'); ?>',
                columnDefs: [{
                    searchable: false,
                    orderable: false,
                    targets: 0,
            ...
            $('body').on('submit', '#dataForm', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('forms.store')); ?>",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $('body').on('click', '.deleteData', function() {
                ...
                if (confirm("Apakah Anda yakin?")) {
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('forms.store')); ?>" + "/" + data_id,
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/pages/form/index.blade.php ENDPATH**/ ?>