    ...
    <div class="container">
        <div class="row">
            <div class="col float-left">
                <h5><i class="fa fa-timeline"></i> <strong>Departemen</strong></h5>
            </div>
            <div class="col">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $(".data-table").DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: '<?php echo route('depts.data'); ?>',
                buttons: [{
                    extend: 'excel',
                    text: 'Cetak ke Excel',
                    // titleAttr: 'Excel',
            ...
            $("#btnSave").click(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('depts.store')); ?>",
            ...
            $('body').on('click', '.deleteData', function() {
                ...
                if (confirm("Apakah Anda yakin?")) {
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('depts.store')); ?>" + "/" + data_id,
                        success: function(data) {
                            table.draw();
                        },
                        error: function(data) {
            ...
            $('body').on('click', '.editData', function() {
                var data_id = $(this).data("id");
                $.get("<?php echo e(route('depts.index')); ?>" + "/" + data_id + "/edit", function(data) {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/pages/dept/index.blade.php ENDPATH**/ ?>