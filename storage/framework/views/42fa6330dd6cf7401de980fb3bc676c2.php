    ...
    <div class="container">
        <div class="row">
            <div class="col float-left">
                <h5><i class="fa fa-users-gear"></i> <strong>Pengaturan User</strong></h5>
            </div>
            <div class="col">
                    ...
                    <form id="dataForm" name="dataForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Email pengguna" aria-label="email"
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <select type="text" class="form-control" id="role" name="role" placeholder=""
                                    ...
                                    <option value=4>Kepala Departmen</option>
                                    <option value=5>Admin Departmen</option>
                                    <option value=6>Interviewer User</option>
                                    <option value=7>Interviewer Management</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <select type="text" class="form-control" id="corp" name="corp" value="">
...
<?php $__env->startSection('content'); ?>
    ...
    <p>* Password default: <b>hris1234</b></p>
<?php $__env->stopSection(); ?>
        ...
        $(function() {
            ...
            $('body').on('click', '.deleteData', function() {
                ...
                if (confirm("Apakah Anda yakin?")) {
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('users.store')); ?>" + "/" + data_id,
                        success: function(data) {
                            table.draw();
                        },
                        error: function(data) {
            ...
            $('body').on('click', '.editData', function() {
                var data_id = $(this).data("id");
                $.get("<?php echo e(route('users.index')); ?>" + "/" + data_id + "/edit", function(data) {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/pages/user/index.blade.php ENDPATH**/ ?>