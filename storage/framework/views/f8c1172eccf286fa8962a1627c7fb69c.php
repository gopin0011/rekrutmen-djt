    ...
    <div class="container">
        <div class="row">
            <div class="col float-left">
                <h5><i class="fa fa-building"></i> <strong>Unit Bisnis</strong></h5>
            </div>
            <div class="col">
                    ...
                    <form id="dataForm" name="dataForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Kode unit bisnis" aria-label="code"
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Nama unit bisnis" aria-label="name"
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $(".data-table").DataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: '<?php echo route('corps.data'); ?>',
                columnDefs: [{
                    searchable: false,
                    orderable: false,
                    targets: 0,
            ...
            $("#btnSave").click(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('corps.store')); ?>",
            ...
            $('body').on('click', '.deleteData', function() {
                ...
                if (confirm("Apakah Anda yakin?")) {
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('corps.store')); ?>" + "/" + data_id,
                        success: function(data) {
                            table.draw();
                        },
                        error: function(data) {
            ...
            $('body').on('click', '.editData', function() {
                var data_id = $(this).data("id");
                $.get("<?php echo e(route('corps.index')); ?>" + "/" + data_id + "/edit", function(data) {
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/pages/corp/index.blade.php ENDPATH**/ ?>