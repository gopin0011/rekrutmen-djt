                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group mb-3  col-md-6">
                                <select type="text" class="form-control" id="opsiresign" name="opsiresign">
                                    <option value="0">Masih Bekerja</option>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('body').on('click', '#showAlper', function() {
                window.location.href = '<?php echo e(route('staffResign.all', ['id' => 'alper'])); ?>';
            });

            $('body').on('click', '#showLegano', function() {
                window.location.href = '<?php echo e(route('staffResign.all', ['id' => 'legano'])); ?>';
            });

            $('body').on('click', '#showAll', function() {
                window.location.href = '<?php echo e(route('staffResign.all', ['id' => 'all'])); ?>';
            });
        });
    </script>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/pages/staff/resign.blade.php ENDPATH**/ ?>