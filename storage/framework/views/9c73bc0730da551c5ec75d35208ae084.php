    ...
    <div class="container">
        <div class="row">
            <div class="col float-left">
                <h5><i class="fa fa-user-check"></i> <strong>Data Staff Aktif</strong></h5>
            </div>
                        ...
                        <div class="form-row">
                            <div class="input-group mb-3 col-md-2">
                                ...
                                <select type="text" class="form-control" id="study" name="study"
                                    value="">
                                    <?php $__currentLoopData = $study; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
        ...
        $(function() {
            ...
            $('body').on('click', '.deleteData', function() {
                ...
                if (confirm("Apakah Anda yakin?")) {
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('staff.store')); ?>" + "/" + data_id,
                        success: function(data) {
                            table.draw();
                        },
                        error: function(data) {
            ...
            $('body').on('click', '.editData', function() {
                var data_id = $(this).data("id");
                $.get("<?php echo e(route('staff.index')); ?>" + "/" + data_id + "/edit", function(data) {
            ...
            $('body').on('click', '#showAlper', function() {
                window.location.href = '<?php echo e(route('staffActive.all', ['id' => 'alper'])); ?>';
            });

            $('body').on('click', '#showLegano', function() {
                window.location.href = '<?php echo e(route('staffActive.all', ['id' => 'legano'])); ?>';
            });

            $('body').on('click', '#showAll', function() {
                window.location.href = '<?php echo e(route('staffActive.all', ['id' => 'all'])); ?>';
            });
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/pages/staff/active.blade.php ENDPATH**/ ?>