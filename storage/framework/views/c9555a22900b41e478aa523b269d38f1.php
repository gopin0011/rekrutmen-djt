    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('body').on('click', '#showAlper', function() {
                window.location.href = '<?php echo e(route('tlhActive.all', ['id' => 'alper'])); ?>';
            });

            $('body').on('click', '#showLegano', function() {
                window.location.href = '<?php echo e(route('tlhActive.all', ['id' => 'legano'])); ?>';
            });

            $('body').on('click', '#showAll', function() {
                window.location.href = '<?php echo e(route('tlhActive.all', ['id' => 'all'])); ?>';
            });
        });
    </script>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/pages/tlh/active.blade.php ENDPATH**/ ?>