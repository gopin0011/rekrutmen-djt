...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('director.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="card">
            <div class="card-body">
                <div class="input-group mb-3 mt-3">
                    <div class="col-12">
                        <input type="text" value="<?php echo e($data->name); ?>" class="form-control"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/pages/director/index.blade.php ENDPATH**/ ?>