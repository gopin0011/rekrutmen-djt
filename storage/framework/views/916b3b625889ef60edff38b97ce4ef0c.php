        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3><?php echo e($countAlper + $countLegano); ?></h3>
                        <p>Total Karyawan</p>
                    </div>
                    <div class="icon">
...
<script src="https://cdn.datatables.net/buttons/2.2.3/js/buttons.print.min.js"></script>
    <script>
        ...
        datasets: [
            {
            data: [<?php echo e($countAlper); ?>,<?php echo e($countLegano); ?>],
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1577460/public_html/rekrutmen/resources/views/home.blade.php ENDPATH**/ ?>