    ...
    <div class="container">
        <div class="row">
            <div class="col float-left">
                <h5><i class="fa fa-people-roof"></i> <strong>Kegiatan Sosial</strong></h5>
            </div>
                        ...
                        <div class="form-row">
                            <div class="input-group mb-3 col-md-12">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1"><i class="fa fa-people-carry-box"></i></span>
                                </div>
                                <input type="text" class="form-control" placeholder="Kegiatan" aria-label="kegiatan"
                                    id="kegiatan" name="kegiatan" aria-describedby="basic-addon1" required>
                            </div>
                        </div>
                        <div class="form-row">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#btnSave").click(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('applicant_activities.store') }}",
            ...
            $('body').on('click', '.deleteData', function() {
                ...
                if (confirm("Apakah Anda yakin?")) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('applicant_activities.store') }}" + "/" + data_id,
                        success: function(data) {
                            table.draw();
                        },
                        error: function(data) {
            ...
            $('body').on('click', '.editData', function() {
                var data_id = $(this).data("id");
                $.get("{{ route('applicant_activities.index') }}" + "/" + data_id + "/edit", function(data) {
