...
<head>
    ...
    <title>Aplikasi Pelamar - {{ $user->name }}</title>
...
<body>
    ...
    <table>
            ...
            <tr>
                ...
                <td style="width:5px">:</td>
                <td style="width: 120px; text-align: left;">{{ $data->kerabat }}</td>
            </tr>

            <tr>
                <td style="width: auto; text-align: right">Jadwal interview</td>
                <td style="width:10px">:</td>
                <td style="width: 120px; text-align: left;"><strong>{{ $tanggal }}</strong></td>
            </tr>
    </table>
    ...
    <table>
        <tbody style="border:1pt solid #000000">
            ...
            <tr>
                ...
                <td style="width:10px">:</td>
                <td style="text-align: left; width:auto" colspan="4">{{ $user->name }}</td>
                <td style="text-align: left; width:100px">Panggilan</td>
                <td style="width:10px">:</td>
                <td style="text-align: left; width:100px">{{ $profil->panggilan ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left; width:120px">e-Mail</td>
                <td style="width:10px">:</td>
                <td style="text-align: left; width:auto" colspan="7">{{ $user->email }}</td>
            </tr>
            <tr>
                <td style="text-align: left; width:120px">Jenis Kelamin</td>
                <td style="width:10px">:</td>
                <td style="text-align: left; width:auto" colspan="4">{{ $gender ?? ''}}</td>
                <td style="text-align: left">Kewarganegaraan</td>
                <td style="width:10px">:</td>
                <td style="text-align: left; width:auto">{{ $profil->wn ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left; width:120px">Tempat, Tanggal Lahir</td>
                <td style="width:10px">:</td>
                <td style="text-align: left; width:auto">{{ $profil->tempatlahir ?? ''}}, {{ $tanggallahir }}</td>

                <td style="text-align: left">Agama</td>
                <td style="width:5px">:</td>
                <td style="text-align: left; width:100px">{{ $agama ?? ''}}</td>

                <td style="text-align: left">Golongan Darah</td>
                <td style="width:10px">:</td>
                <td style="text-align: left">{{ $profil->darah ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left; width:120px">Nomor KTP</td>
                <td style="width:10px">:</td>
                <td style="text-align: left" colspan="7">{{ $profil->nik ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left">Alamat sesuai KTP</td>
                <td style="width:10px">:</td>
                <td style="text-align: left" colspan="7">{{ $profil->alamat ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left">Alamat Domisili</td>
                <td style="width:10px">:</td>
                <td style="text-align: left" colspan="7">{{ $profil->domisili ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left; width:120px">Nomor Kontak</td>
                <td style="width:10px">:</td>
                <td style="text-align: left" colspan="7">{{ $profil->kontak ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left">Status Perkawinan</td>
                <td style="width:10px">:</td>
                <td style="text-align: left" colspan="7">{{ $profil->status ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left">Hobi</td>
                <td style="width:10px">:</td>
                <td style="text-align: left" colspan="7">{{ $profil->hobi ?? ''}}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table>
        <tbody style="border:1pt solid #000000">
            ...
            <tr>
                ...
                <td style="border:1pt solid #000000">{{ $ayah->nama}}</td>
                <td style="border:1pt solid #000000">{{ $ayah->gender == 'Pria' ? 'L' : 'P'}}</td>
                <td style="border:1pt solid #000000">{{ $ayah->ttl}}</td>
                <td style="border:1pt solid #000000">{{ $ayah->pendidikan}}</td>
                <td style="border:1pt solid #000000">{{ $ayah->pekerjaan}}</td>
            </tr>
            @endif
            $@if ($ibu)
            <tr>
                <td style="border:1pt solid #000000">Ibu</td>
                <td style="border:1pt solid #000000">{{ $ibu->nama}}</td>
                <td style="border:1pt solid #000000">{{ $ibu->gender == 'Pria' ? 'L' : 'P'}}</td>
                <td style="border:1pt solid #000000">{{ $ibu->ttl}}</td>
                <td style="border:1pt solid #000000">{{ $ibu->pendidikan}}</td>
                <td style="border:1pt solid #000000">{{ $ibu->pekerjaan}}</td>
            </tr>
            @endif
            {{ $i = 1; }}
            @foreach ($kakak as $row)
            <tr>
            ...
            <tr>
                <td style="border:1pt solid #000000">Anak {{ $i++ }}</td>
                <td style="border:1pt solid #000000">{{ $user->name}}</td>
                <td style="border:1pt solid #000000">{{ $profil->gender ?? '' == '0' ? 'L' : 'P'}}</td>
                <td style="border:1pt solid #000000">{{ $profil->tempatlahir ?? ''}},{{ $tanggallahir}}</td>
                <td style="border:1pt solid #000000">{{ $study[0]->tingkat ?? ''}}</td>
    ...
    @if ($profil->status ?? 'Lajang' != 'Lajang')
    <table>
        <tbody style="border:1pt solid #000000">
            <tr>
            ...
            <tr>
                <td style="border:1pt solid #000000">{{ $pasangan->status ?? ''}}</td>
                <td style="border:1pt solid #000000">{{ $pasangan->nama ?? ''}}</td>
                <td style="border:1pt solid #000000">{{ $pasangan->gender  ?? '' == 'Pria' ? 'L' : 'P' }}</td>
                <td style="border:1pt solid #000000">{{ $pasangan->ttl ?? ''}}</td>
                <td style="border:1pt solid #000000">{{ $pasangan->pendidikan ?? ''}}</td>
                <td style="border:1pt solid #000000">{{ $pasangan->pekerjaan ?? ''}}</td>
            </tr>
            {{ $x = 1; }}
            @foreach ($anak as $row)
            <tr>
        ...
        <tbody style="border:1pt solid #000000">
           ...
           <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td colspan="7" style="text-align: left">{{ $row->masuk}} - {{ $data->keluar}}</td>
            </tr>
            <tr>
    ...
    <table>
        <tbody style="border:1pt solid #000000">
            ...
            <tr>
                <td style="text-align: left; width:200px"><strong>{{$data->namahr}}</strong></td>
            </tr>
            <tr>
                <td style="text-align: left">{{ $data->inthr }}</td>
            </tr>
            <tr>
                <td style="text-align: left; width:200px"><strong>{{$data->namauser}}</strong></td>
            </tr>
            <tr>
                <td style="text-align: left">{{ $data->intuser }}</td>
            </tr>
            <tr>
                <td style="text-align: left; width:200px"><strong>{{$data->namamana}}</strong></td>
            </tr>
            <tr>
                <td style="text-align: left">{{ $data->intmana }}</td>
            </tr>
        </tbody>
    </table>
</body>
