    ...
    <div class="container">
        <div class="row">
            <div class="col float-left">
                <h5><i class="fa fa-people-carry-box"></i> <strong>Data TLH Resign</strong></h5>
            </div>
            <div class="row">
                ...
                <a type="button" href="javascript:void(0)" id="showLegano5"
                    class="btn btn-default float-right ml-1">Legano</a>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('body').on('click', '#showAlper', function() {
                window.location.href = '{{ route('tlhResign.all', ['id' => 'alper']) }}';
            });

            $('body').on('click', '#showLegano', function() {
                window.location.href = '{{ route('tlhResign.all', ['id' => 'legano']) }}';
            });

            $('body').on('click', '#showLegano5', function() {
                window.location.href = '{{ route('tlhResign.all', ['id' => 'legano5']) }}';
            });

            $('body').on('click', '#showAll', function() {
                window.location.href = '{{ route('tlhResign.all', ['id' => 'all']) }}';
            });
        });
    </script>
